    ...
    return (
        <main className="h-full sm:h-[90vh] w-full flex flex-col px-4 pt-5 gap-4 text-text">
            <header className="flex justify-between">
                <h1 className="text-lg sm:text-2xl font-bold">User Profile</h1>
                <button
                    onClick={() => logoutUser()}
                    className="w-24 px-4 py-1 bg-red-600/90 text-white rounded-md hover:bg-red-600/80"
                >
                    Log Out
                </button>
            </header>

            <section className="text-[16px] sm:text-[18px] flex flex-col gap-2">
                <article>
